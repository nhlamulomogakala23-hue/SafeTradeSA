<footer class="bg-dark pt-4 pb-4 mt-5">
    <div class="container text-center">
        ...
        <p class="text-light small mb-0" style="opacity: 0.8;">
            <span class="text-success fw-bold">&copy; 2026 SafeTrade SA</span> &middot; Securing informal Digital Commerce across South Africa.
        </p>
