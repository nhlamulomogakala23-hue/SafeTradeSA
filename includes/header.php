<header class="bg-white border-bottom sticky-top py-3 mb-4">
    <div class="container d-flex justify-content-between align-items-center">
        <a href="/SafeTradeSA/index.php" class="fw-bold text-dark text-decoration-none h4 mb-0">SafeTrade SA</a>
        <nav class="d-flex align-items-center">
            <a href="/SafeTradeSA/index.php" class="text-dark text-decoration-none mx-2">Home</a>
