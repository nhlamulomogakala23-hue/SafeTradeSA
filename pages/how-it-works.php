...
<head>
    ...
    <style>
        .step-number { font-size: 2.5rem; font-weight: 800; color: #212529; opacity: 0.15; line-height: 1; }
    </style>
</head>
<body class="bg-light">
    ...
    <div class="row g-4 justify-content-center">
        <div class="col-md-4">
            <div class="card h-100 border-0 shadow-sm p-4 bg-white position-relative">
                ...
                <p class="text-muted small">Every trader completes a secure South African ID and phone validation check before listing items.</p>
                <span class="badge bg-secondary align-self-start px-2 py-1 mt-auto" style="font-size: 0.75rem;">100% Verified</span>
            </div>
        </div>
        <div class="col-md-4">
            <div class="card h-100 border-0 shadow-sm p-4 bg-white position-relative">
                ...
                <p class="text-muted small">When a buyer wants an item, their payment is safely held in our secure escrow protection vault.</p>
        ...
        <div class="col-md-4">
            <div class="card h-100 border-0 shadow-sm p-4 bg-white position-relative">
                ...
                <p class="text-muted small">Once the buyer is satisfied with the product, the funds are instantly released to the seller.</p>
                <span class="badge bg-primary align-self-start px-2 py-1 mt-auto" style="font-size: 0.75rem;">Fair & Honest</span>
            </div>
        </div>
    </div>
